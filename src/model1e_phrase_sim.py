...
from bertwrapper import BERT1EWrapper
...
class BERT1E_sim(PhraseSim):
    ...
    def __init__(self, model_dir, model_name, pooling, seed):
        ...
        # Prepare model
        self.model = BERT1EWrapper(config_model)
    ...
    def encode(self, s_tokens, t_tokens, s_trees, t_trees):
        ...
        for step, batch_idx in enumerate(tqdm(dataloader_idx, desc="Iteration")):
            ...
            bert_embeddings = self.model.encode_sentence(batch['features'])
    ...
    def align_score(self, n, m, sent_idx):
        s_emb, t_emb = self.model.similarity(self.sent_vectors, sent_idx, n, m, self.pooling_method)
